...
public class LectureDTO {
    ...
    public LectureDTO(int lectureId, String title, String startTime, String endTime, String placeAddress1, String placeAddress2, String placeAddress3, String explanation, String lectureType, int maxTeacherNum, int maxStudentNum, List<String> lectureImageUrls) {
    ...
    public LectureDTO(LectureModifyDTO lecture) {
    ...
    public LectureDTO(int lectureId,LectureRegisterDTO lecture) {
        this.lectureId = lectureId;
        this.title = lecture.getTitle();
        this.startTime = lecture.getStartTime();
        this.endTime = lecture.getEndTime();
...
//        }
    ...
    public void setLectureImageUrls(List<LectureImage> lectureImages){
