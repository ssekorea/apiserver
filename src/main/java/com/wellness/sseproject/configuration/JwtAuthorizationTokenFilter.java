...
public class JwtAuthorizationTokenFilter extends OncePerRequestFilter {
    ...
    public JwtAuthorizationTokenFilter(UserQueryService queryService, JwtTokenUtil jwtTokenUtil, @Value("${jwt.header}")String tokenHeader){
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (userId != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            UserInfoDTO user = this.queryService.getUserInfoDTOById(userId);
            ...
            if (jwtTokenUtil.validateToken(authToken, user)) {
                ...
                logger.info("authorizated user '{}', setting security context", userId);
